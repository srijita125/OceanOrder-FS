...
function Faq() {
  return (
   <div className='my-10'>
    <div
    className="relative w-full bg-white px-6 pt-10 pb-8 mt-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto  sm:rounded-lg sm:px-10">
    <div className="mx-auto px-5">
        <div className="flex flex-col">
            <h3 className="mt-5  text-3xl font-bold tracking-tight md:text-5xl">FAQ</h3>
